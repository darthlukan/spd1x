...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname lecture_compound-data-definition) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; PROBLEM:
;;
